...
export class LandingPageComponent {
  ...
  imagen1: string="../../assets/imagenes/caracteristica1.png"
  imagen2: string="../../assets/imagenes/caracteristica2.png"
  imagen3: string="../../assets/imagenes/caracteristica3.png"
  imagen4: string="../../assets/imagenes/caracteristica4.png"
}
